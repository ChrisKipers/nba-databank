...
object StatsAPIImpl extends StatsAPI {
  val nbaBaseUrl = "http://stats.nba.com/stats/"

  override def get(endpoint: String, params: Map[String, String], delayInMillis: Int = 0)(implicit exec: ExecutionContext): Observable[(String, List[NbaResult])] = {
  ...
  override def getResultStreamFromRequestStream(requestStream: Observable[(String, List[NbaResult])], targetResultName: String): Observable[NbaResult] = {
